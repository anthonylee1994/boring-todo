...
(function () {
  ...
  function G(a, b) {
    function d(f, c, h, m) {
      ...
      m && (c = m.width / e, e = m.height / e, 128 < e && (c /= e / 128, e = 128), 48 <= c && 48 <= e && (l.drawImage(m, c / -2, e / -2, c, e), l.translate(0, e / 2 + 20)));
      ...
      m = c.j || 24;
      l.translate(0, m);
      if (c.width < 0.8 * f) l.fillText(e, c.width / -2, 0);else for (e = e.split(/\s+/g), c = 1; c <= e.length; ++c) {
  ...
  function V(a, b) {
    if (A || Y) {
      var d = N(a);
      if (A) k('apple-mobile-web-app-status-bar-style', b ? 'black-translucent' : d ? 'black' : 'default');else {
        a: {
          try {
        ...
        if (b = g) d = d ? 255 : 0, b.foregroundColor = {
          r: d,
          g: d,
          b: d,
          a: 255
        }, a = O(a), b.backgroundColor = {
          r: a[0],
          g: a[1],
          b: a[2],
          a: a[3]
